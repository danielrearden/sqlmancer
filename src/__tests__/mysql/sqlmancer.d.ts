...
> extends FindManyBuilder<'mysql', ActorFields, ActorIds, ActorEnums, ActorAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
...
> extends FindOneBuilder<'mysql', LanguageFields, LanguageIds, LanguageEnums, LanguageAssociations, TSelected> {
  constructor(options: BuilderOptions)
}

export declare class LanguageFindManyBuilder<
  TSelected extends Pick<LanguageFields, any> = LanguageFields
> extends FindManyBuilder<'mysql', LanguageFields, LanguageIds, LanguageEnums, LanguageAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
