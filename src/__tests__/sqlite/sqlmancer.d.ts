...
> extends FindManyBuilder<'sqlite', ActorFields, ActorIds, ActorEnums, ActorAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
...
> extends FindOneBuilder<'sqlite', CategoryFields, CategoryIds, CategoryEnums, CategoryAssociations, TSelected> {
  constructor(options: BuilderOptions)
}

export declare class CategoryFindManyBuilder<
  TSelected extends Pick<CategoryFields, any> = CategoryFields
> extends FindManyBuilder<'sqlite', CategoryFields, CategoryIds, CategoryEnums, CategoryAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
...
> extends FindOneBuilder<'sqlite', LanguageFields, LanguageIds, LanguageEnums, LanguageAssociations, TSelected> {
  constructor(options: BuilderOptions)
}

export declare class LanguageFindManyBuilder<
  TSelected extends Pick<LanguageFields, any> = LanguageFields
> extends FindManyBuilder<'sqlite', LanguageFields, LanguageIds, LanguageEnums, LanguageAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
...
> extends FindOneBuilder<'sqlite', CustomerFields, CustomerIds, CustomerEnums, CustomerAssociations, TSelected> {
  constructor(options: BuilderOptions)
}

export declare class CustomerFindManyBuilder<
  TSelected extends Pick<CustomerFields, any> = CustomerFields
> extends FindManyBuilder<'sqlite', CustomerFields, CustomerIds, CustomerEnums, CustomerAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
...
> extends FindOneBuilder<'sqlite', AddressFields, AddressIds, AddressEnums, AddressAssociations, TSelected> {
  constructor(options: BuilderOptions)
}

export declare class AddressFindManyBuilder<
  TSelected extends Pick<AddressFields, any> = AddressFields
> extends FindManyBuilder<'sqlite', AddressFields, AddressIds, AddressEnums, AddressAssociations, TSelected> {
  constructor(options: BuilderOptions)
}
