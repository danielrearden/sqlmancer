...
export class ValueDirective extends SchemaDirectiveVisitor<any, any> {
  visitEnumValue(enumValue: GraphQLEnumValue, details: { enumType: GraphQLEnumType }): void {
    ...
    enumType._valueLookup = new Map(enumType._values.map((value: GraphQLEnumValue) => [value.value, value]))
